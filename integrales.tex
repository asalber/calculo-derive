...
\item Seleccionar el menu \menu{Calculo > Integrales} o hacer clic en el botón \boton{Calcular integral}.
\item En el cuadro de diálogo que aparece marcar la opción \option{Indefinida}, introducir la constante \comando{C} en el campo \campo{Constante} y hacer clic en el botón \boton{Simplificar}.
\end{enumerate}
...
\item En el cuadro de diálogo que aparece marcar la opción \option{Definida}, introducir \comando{-1/2} en el campo \campo{Límite inferior}, introducir \comando{0} en el campo \campo{Límite superior} y hacer clic en el botón \boton{Simplificar}.
\end{enumerate}
...
\end{enumerate}
Para calcular el area de la región introducir la expresión \comando{INT(ABS(f(x)-g(x)), x, 0, 2pi)} en la ventana de Álgebra y hacer clic en el botón \boton{Simplificar}.
\end{indicacion}
