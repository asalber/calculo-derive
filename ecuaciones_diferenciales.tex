...
\begin{enumerate}
\item Introducir la expresión \comando{DSOLVE1\_GEN(1-x,x\^{}2+x,x,y,c)}.
\item Hacer clic en el botón \boton{Simplificar}.
\end{enumerate}
Para dibujar las curvas integrales:
\begin{enumerate}[resume]
...
\begin{enumerate}
\item Introducir la expresión \comando{DSOLVE1(sqrt(1-y\^{}2),ysqrt(1-x\^{}2),x,y,0,1)}.
\item Hacer clic en el botón \boton{Simplificar}.
\end{enumerate}
}
\end{indicacion}
...
variable $y$ e introducir el valor $4.5$, y hacer clic en el botón \boton{Simplificar}.
\item Hacer clic en el botón \boton{Resolver o despejar}, seleccionar el domino Real y hacer clic en el botón
\boton{Simplicar}.
\end{enumerate}
...
\item Hacer clic en el botón \boton{Sustituir}, seleccionar la variable $k$ e introducir el valor de la constante
calculado antes, seleccionar la variable $y$ e introducir el valor $0.68$, y hacer clic en el botón \boton{Simplificar}.
\item Hacer clic en el botón \boton{Resolver o despejar}, seleccionar el domino Real y hacer clic en el botón
\boton{Simplicar}.
\end{enumerate}
}
