%$HeadURL: https://practicas-derive.googlecode.com/svn/trunk/limites_continuidad.tex $
...
\boton{Representar Expresión}. Probablemente haya que cambiar la
escala de la representación original pinchando en el botón de
\boton{Zoom hacia fuera en ambos ejes}, para tener una perspectiva
...
ello, puede resultar conveniente pinchar en el botón \boton{Trazar
gráficas}, para que el cursor sólo pueda desplazarse a lo largo de
la misma.
...
\item Utilizar el menú \menu{Cálculo->Límites}, o su
...
ventana 2D, y utilizar el botón \boton{Representar Expresiones}).
...
\begin{indicacion}
{Utilizar el botón \boton{Calcular un Límite}, y escoger la
...
los límites anteriores mediante el botón \boton{Calcular un límite}.
...
utilizar el botón \boton{Calcular un límite} de la barra de botones,
y activar la tendencia por \opcion{Ambas} en el cuadro de diálogo
que aparece. Si dicho límite existe, entonces la discontinuidad es
evitable.

\item Si el límite no existe, puede que sí que existan los
laterales. Para calcularlos utilizar el botón \boton{Calcular un
límite} y activar la tendencia por la \opcion{Izquierda} y luego por
la \opcion{Derecha}. Si ambos límites laterales existen pero no son
...
tramo por \comando{CHI}$(\infty,x,0)$, y el segundo por
