...
hasta orden 4, utilizando, por ejemplo, el botón \boton{Hallar una derivada} de la barra de botones, escogiendo el orden adecuado.
...
\boton{Hallar una derivada} tan sólo podemos introducir como orden de la misma un número entero, pero nunca un parámetro como $n$, no queda
...
\begin{indicacion}
\begin{enumerate}
\item Calcular la primera derivada (botón \boton{Hallar una derivada}) y encontrar sus raíces (botón \boton{Resolver o despejar}). Con ello
